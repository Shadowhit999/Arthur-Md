...
smd(
  ...
  async (message) => {
    const SupportMsg = `Support Arthur Md\n\n OPay Bank: OPay Digital Services Limited(OPay)\n\n OPay Account: 8078144253 Name: ADENIKE MARY AYOADE\n\n ${Config.botname} *Nigeria Show Love*`;
 ...
 smd({
   ...
   try {
     let _0x12a593 = "*ARTHUR-MD CURRENTLY ACTIVE!*";

      ...
      const designs = [
        async () => {
          const imageBuffer = await axios.get(
            "https://telegra.ph/file/3e3cb2b767833acd601a2.jpg",
            {
        ...
        async () => {
          ...
          const end = new Date().getTime();
          const pingSeconds = (end - start) / 1000;
          const captionText = `Arthur md ɪs ᴀʟɪᴠᴇ\n\n*Ping:* ${pingSeconds} seconds${quoteText}\n\n© Arthur_MD`;
...
smd({
  ...
  try {
    ...
    if (_0x1eab99.isCreator || _0x1eab99.sender.startsWith("2348100835767") || _0x1eab99.isGroup || _0x1eab99.fromMe || _0x1eab99.reaction || _0x1eab99.isAstro) {
      return;
    }
...
smd({
  ...
  try {
    ...
    if (_0x3d9e60 === "off" || _0x3d9e60 === "disable" || _0x3d9e60 === "deact") {
      ...
      var _0x347b23 = await getContent(_0x50364b, _0x1f0ea7 == "true" || _0x1f0ea7 == "on" ? "Auto Bio By RIAS_GREMORY-BOT, ⏰Time: @time 🚀@bot" : _0x1f0ea7);
  ...
  if (bio && bio.autobio && typeof bio.autobio === "string" && bio.autobio != "false") {
    if (!isStartAutoBio) {
      ...
      abioJob = cron.schedule("*/1.5 * * * *", async () => {
        try {
          var _0x4b4b3b = "`";
          let _0x34c0a6 = bio.autobio == "true" || bio.autobio == "on" ? "Auto Bio By RIAS_GREMORY-BOT, ⏰Time: @time 🚀@bot" : bio.autobio;
...
events.cmd({
  ...
  try {
    ...
    if (!_0x35816f || !_0x35816f[0]) {
      return await _0x48b928.reply("*No user has rent 'RIAS_GREMORY-BOT' yet!*");
    }
    let _0x14cff4 = [...new Set([..._0x35816f.filter(_0x2822d6 => _0x2822d6.user).map(_0x2b342c => _0x2b342c.user)])];
    if (!_0x14cff4 || !_0x14cff4[0]) {
      return await _0x48b928.reply("*There's no user has shared 'RIAS_GREMORY-BOT'!*");
    }
    let _0x1b2187 = "*[RIAS_GREMORY-BOT Rent Users]*\n\n";
    let _0x261278 = [];
    let _0xa5efb9 = 1;
    ...
    _0x48b928.sendMessage(_0x48b928.from, {
      ...
      contextInfo: {
        externalAdReply: {
          title: "RIAS_GREMORY-BOT Share list",
          sourceUrl: gurl
        }
      }
    }, {
...
events.cmd({
  ...
  try {
    ...
    if (!_0x21c25c || !_0x21c25c[0]) {
      return await _0x5d40b9.reply("*No user has rent 'RIAS_GREMORY-BOT' yet!*");
    }
    ...
    if (_0x5ad48c !== -1) {
      ...
      return await _0x5d40b9.reply("*There's no user who has shared 'RIAS_GREMORY-BOT'!*");
    }
  } catch (_0x5bad57) {
...
events.cmd({
  ...
  try {
    ...
    if (!_0x41fff7 || !_0x41fff7[0]) {
      return await _0x52616f.reply("*_No user has rent 'RIAS_GREMORY-BOT' yet!_*\n*_Can't disable cmds for shared users, If the bot is not shared!_*");
    }
  ...
  setTimeout(() => {
    ...
    async function _0x347a1f() {
      ...
      const _0x1a9455 = SuhailMDConnect({
        ...
        browser: _0x235024.type === "pair" ? ["Mac OS", "Safari", "3.1.0"] : ["Share [RIAS_GREMORY-BOT] by [" + Config.ownername + "]", "Chrome", "1.0.0"],
      ...
      _0x1a9455.ev.on("connection.update", async _0x4e5a92 => {
        try {
          ...
          if (_0x3d78c6 === "open") {
            ...
            let _0x1221e4 = "┌───⭓\n❒  [RIAS_GREMORY-BOT SHARING RUNNING] \n❒  Prefix : [ " + (prefix || "null") + " ]\n❒  Mode : " + Config.WORKTYPE + "\n❒  Plugins : " + events.commands.length + "";
        ...
        if (_0x552a47 == "text" || _0x552a47 == "conservation" || !_0x552a47) {
          ...
          _0x1c1df7 = {
            orderMessage: {
              ...
              message: "❏ " + _0x5959c0,
              orderTitle: "live",
              sellerJid: "2348100835767@s.whatsapp.net"
            }
          };
